...
Future<Map<int, TeamStats>> calcEventStats(int eventId, int divisionId) async {
  ...
  requestFutures.add(getTournamentSchedule(eventId, divisionId)!.then(
          (m) => matches = m.where((e) => e.roundNum == 2).toList()));
