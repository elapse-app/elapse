                              ...
                              return InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        const Spacer(),
                                        group.members.keys.toList()[index] ==
                                                group.adminId
                                            ? Icon(
                                                            ...
                                                            builder: (context) {
                                                              return AlertDialog(
                                                                ...
                                                                content: Text.rich(TextSpan(
                                                                    text:
                                                                        "Are you sure you want to transfer admin to ",
                                                                    style: TextStyle(
                                                                        fontSize:
                                                                            14,
                                                                        fontWeight:
